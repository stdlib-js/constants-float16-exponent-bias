...
```javascript
FLOAT16_EXPONENT_BIAS = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-exponent-bias@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-exponent-bias@umd/bundle.js"></script>
```
