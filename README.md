...
```javascript
import FLOAT16_EXPONENT_BIAS from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-exponent-bias@v0.3.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float16-exponent-bias/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/constants-float16-exponent-bias/actions/workflows/test.yml?query=branch:v0.3.0
